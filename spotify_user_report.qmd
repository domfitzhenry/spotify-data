...
| Sessions | `r current_sessions` | `r total_sessions` |
...
#| fig-width: 13.5
#| fig-height: 5
#| fig-cap: "Your top artists popularity, bubble size indicates followers"
#| fig-format: svg
...
artist_annotation %>%
  ...
  geom_jitter(
    aes(size = followers), colour = spotify_green, alpha = 0.8, 
    width = 0.5, height = 0
    ) +
  geom_text_repel(
