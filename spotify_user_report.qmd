...
[`r current_tracks`]{style="font-size: 40pt"}\
**tracks** appearing on

[`r current_albums`]{style="font-size: 30pt"}\
**albums** performed by

[`r current_artists`]{style="font-size: 20pt"}\
**artists**.
...
The popularity of your top 10 artists and the 5 artists with the most followers. Bubble size represents the number of followers while the axes show how popular the artist is with you versus the world.
...
artist_annotation <- union(
  ...
  slice_max(top_artists, order_by = tibble(followers, artist_popularity), n = 5)
  ) %>%
  mutate(
...
#[Something about related artists]{.text-warning}
